...
public class VentanaAdmin extends JFrame {
	...
	private void agregarComponentes() {
		...
		textoSentenciaSql = new JTextArea();
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(tablaResultado, GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE)
								.addComponent(textoSentenciaSql, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE))
							.addPreferredGap(ComponentPlacement.RELATED))
						.addComponent(lblSentencia)
						.addComponent(btnConfirmar)
						.addComponent(lblResultado))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panelTablas, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addComponent(panelTablas, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 433, Short.MAX_VALUE)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblSentencia)
							.addPreferredGap(ComponentPlacement.RELATED)
							...
							.addComponent(lblResultado)
							.addGap(8)
							.addComponent(tablaResultado, GroupLayout.DEFAULT_SIZE, 247, Short.MAX_VALUE)))
		...
		gl_panelTablas.setHorizontalGroup(
			gl_panelTablas.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelTablas.createSequentialGroup()
					.addGroup(gl_panelTablas.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panelTablas.createSequentialGroup()
							.addContainerGap()
							.addComponent(listaAtributos, GroupLayout.PREFERRED_SIZE, 302, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panelTablas.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(gl_panelTablas.createSequentialGroup()
								.addContainerGap()
								.addComponent(listaTablas, GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE))
							.addGroup(gl_panelTablas.createSequentialGroup()
								.addGap(123)
		...
		gl_panelTablas.setVerticalGroup(
			gl_panelTablas.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelTablas.createSequentialGroup()
					...
					.addComponent(lblAtributos)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(listaAtributos, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
		);
